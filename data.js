const data = [
  {
    ...
    type: "Force",
    description:
      "Effects: Creates an aura around you that does various things to hurt enemies who are inside it. Turbobuffs hooks and makes bestiary/banner quotas fill up much more quickly. Gain one crit reroll on every attack after picking up any pickup (see pearlwood ench for more info). \n\nThe aura does many things to deal damage from seedler projectiles to snowballs, and combined they have an okay-ish effect, but the pearlwood crit reroll only has an effect when your crit isn\u2019t 100% already.\n\nNOTE: This does NOT reroll failed cosmic core supercrit attempts, only regular crits.\n\nDon\u2019t forget the banner buff while equipped; if anything you need has a banner recipe, equip this while grinding, just like with Wood Enchantment.",
    availability: "Post-Moon Lord",
    parent: "Soul of Terraria",
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Gives the player a discount based on bestiary completion, even in a vanity slot, and makes bestiary entries and banners complete twice as fast when equipped in a real slot. \n\nFree money and items (since banners can be turned into many items in this mod) and it\u2019s dirt cheap to craft. Has no direct combat utility, but the banner feature only works when equipped. \n\nThe wizard enchantment boosted version lets you complete banners five times as fast, and you can craft banners into many useful items thanks to Mutant mod, so it\u2019s arguably better than a wizard-boosted platinum enchantment for farming when there\u2019s one specific item you need and it has a banner recipe, and you don't care about any other drops.",
    availability: "Pre-Boss",
    parent: "Force of Timber",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Creates an aura around you. While enemies are in the aura, your Corruption meter builds up, and it lowers when enemies aren\u2019t in the aura. As the meter fills up, it grants you increasing amounts of flat damage and damage reduction, up to 5 extra damage on all hits and 5% damage reduction. \n\nThis is essentially free damage on every hit and a small defensive boost, so long as you have charge in the meter: the more hits you make, the more powerful it is. Shines on rapid fire weapons and when using extra minions and attacks. Requires some upkeep to maintain the damage, but this gives you an actual reason to stay near the boss when using your minishark or whatever. \n\nThe Wizard version is particularly good on the Blade Staff\u2019s minions since the flat damage boost goes up to a maximum of 10, and flat damage is great on that.",
    availability: "Pre-Boss",
    parent: "Force of Timber",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Grants you an active skill: when used, you parry the next attack in a 0.33 second window. Parrying an attack reduces its damage by 100, and if you time your parry so that it\u2019s immediately before the hit, you also gain the Striking Moment buff. The parry has 1.67 second cooldown, and it cannot be used while attacking or during your weapon\u2019s use time cooldown. \n\nRight click (assuming skill is bound to right click) when attacked to take no damage; this accessory can make you immortal if you manage to parry everything, so long as nothing does more than 100 damage (or 200 for the wizard version). You can\u2019t parry an attack after you\u2019ve been hit, so you need to see it coming: you can always parry as a precaution if you think an attack will miss but aren\u2019t sure. Also, if you don\u2019t remember to parry, this accessory is useless, but I assume you\u2019ll only equip this if you bother to use it. This would be five stars if you parried all or most hits, but I assume most people won\u2019t manage to pull it off.\nStriking Moment only applies to one hit, so use it on a high damage per hit weapon (mythril sword perhaps). \n\nTIP FOR PARRYING: You can\u2019t parry during your weapon\u2019s use time cooldown, so wait for your weapon to vanish before right clicking.",
    availability: "Pre-Boss",
    parent: "Force of Terra",
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Enlarges held melee weapons like swords and spears by 50%, and increases whip range by 20%. Attacks create shockwaves based on the original attack\u2019s damage every 2.5 seconds, but the shockwave does less damage on the original target. \n\n50% sounds like a moderate boost, but it\u2019s much larger than it sounds, and it makes the difference between some melee weapons being impossible to use on bosses and those melee weapons actually being usable. Many melee weapons also have extremely high DPS, so being able to deal that without dying from contact damage is also great. The shockwave damage is a great side bonus and particularly good on crowds and worms, and is strongest with slow high damage weapons (such as Volcano, and even rarely on non-melee weapons such as Calamity\u2019s Eviscerator).",
    availability: "Pre-Boss",
    parent: "Force of Terra",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Hitting an enemy grants palladium regen for a short duration, and every 80 damage healed from anything spawns an homing orb that does damage to enemies. \n\nOne of the simplest enchantments. The regeneration is alright, and the damage is a very small bonus. Buff is redundant with the palladium weapons, so don\u2019t use them together. Despite being weak, it's useful on any build, unless you\u2019re nohitting.",
    availability: "Hardmode",
    parent: "Force of Earth",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Buffed titanium armor set bonus: deals more damage, and when you hit max shards, you gain a damage reduction buff that gets stronger when you\u2019re closer to an enemy, ranging from 10-30% based on distance. After getting hit, you keep the buff for a few seconds and can\u2019t gain new shards for 15 seconds.\n\nPowerful on close range builds since the shard damage is surprisingly high and the damage reduction is straightforwardly great.",
    availability: "Hardmode",
    parent: "Force of Earth",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Grants immunity to Wet, gives effects of the inner tube, and summons an umbrella that can reflect projectiles from above. The umbrella can take 200 damage, and then it goes on a 15 second cooldown before reappearing. When there is an umbrella, you also have the effects of a featherfall potion. Your attacks also inflict the Wet debuff. \n\nUseful for bosses that occasionally hit you from above, but nobody ever crafts this thing since it\u2019s hard to make early on. By the time they craft it, they already killed King Slime, who\u2019s slime rain-themed attacks this would be perfect for. Still usable on Queen Bee and other bosses though. Featherfall effect may annoy some, but others will like it. The upsides remain useful even in hardmode, but by then you have stronger accessories.",
    availability: "Pre-Boss",
    parent: "Force of Nature",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Same as snow enchantment, but inflicts Frostbite instead of Frostburn, and the five snowballs are replaced with ten icicles that fly faster. They also briefly immobilize nearly any enemy or boss on hit. \n\nThe damage and debuff just aren\u2019t very good, but the ability to freeze bosses in place, however briefly, does barely earn this a second star. There\u2019s theoretical mythril synergy here but I doubt it\u2019s actually all that good.",
    availability: "Hardmode",
    parent: "Force of Nature",
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Grants a double jump that leaves damaging spores and the ability to do a short dash. \n\nA dash and a double jump are both useful, but your mileage may vary. Some people can\u2019t live without a dash, and other people don\u2019t find them that useful. I was tempted to give this a \u2753 ranking, but the dash is straightforwardly good enough and the jump is straightforwardly good enough and the spores are a nice enough bonus for this to get three stars.",
    availability: "Pre-Boss",
    parent: "Force of Nature",
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Effects of Jungle Enchantment, but with more spore damage. Additionally, a ring of leaf crystals surround you and shoot lasers at nearby enemies. Flying using wings also causes spores to constantly spawn below you, damaging enemies. \n\nThe dash and double jump aren\u2019t that great, but they\u2019re fine, especially for people who can\u2019t live without a dash. The biggest feature is the leaf crystal ring, but if you try to use it on plantera, their crystal rings will absorb most of its shots, and chlorophyte enchantment\u2019s damage isnt as good when the boss has more HP and your weapons are stronger. Golem\u2019s hands don\u2019t attract crystal lasers, but he\u2019s remarkably tanky. This makes Lifelight uniquely susceptible to this enchantment, since she has nothing to absorb hits and is less durable than later bosses despite her high damage reduction. Equip this whenever you fight Lifelight.",
    availability: "Post-Mech Bosses",
    parent: "Force of Nature",
  },
  {
  ...
  },
  {
    ...
    type: "Force",
    description:
      "Effects: Increases critical strike chance in general by 15%. Grants extremely powerful wings with a very long flight time. While flying, you leave behind flowers that when fully grown and touched, heal you, refresh your flight time, and grant the Ambrosia buff for 6 seconds which grants weak summoner crits, massive melee boosts, and massive defensive boosts. Enemies that deal contact damage to you also take 500% of it reflected back to themselves. Effects of Hive Pack. \n\nThis is one of the core mobility options you have access to post-moon lord: it’s this, Flight Mastery Soul, or Force of Will for the most part. The flight statistics are slightly worse than Flight Mastery Soul and the flight isn’t infinite without touching flowers, but you get some other stuff thrown in, so I consider it to be better. \n\nThe short lived flower buffs are good on any class, but are particularly good on summoner and melee characters. If you do use melee weapons that benefit from speed, such as Slime Slinging Slasher, this is even better, and if you have Cosmic Core, your minions can supercrit while you’re ambrosia’d. \n\nThe only downside is that you won’t have infinite flight unless you pick up flowers, but Heart of the Master boosts flight time by 50 %, making it a good accessory to pair with this since it makes the flight effectively infinite. A single Instabridge in your sky also lets you occasionally land to refresh flight time. Finally, a mount can be used if you’re desperate to avoid falling and somehow run out of flight time. \n\nUnusually enough in the DLC, you tend to wind up with some wing speed buffs, which makes this basically just a Flight Mastery Soul with finite flight time.",
    availability: "Post-Moon Lord",
    parent: "Soul of Terraria",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Gives you wings that are the strength of Fledgling Wings. While you\u2019re flying, spawn flowers that, when fully bloomed, spawn bees upon you or an enemy touching it; you also gain the honey buff when you touch them. Effects of Hive Pack. \n\nFledgling wings are alright, but nothing special. The bee damage is okay, and the honey buff is nice if you aren\u2019t getting it from somewhere else. Hive Pack can massively increase summoner damage since it gives Hornet staff a massive damage increase, making this the best on summoners. \n\nIf you want wings or you\u2019re a summoner, this is the perfect enchantment for you, but make sure to combine it with any form of rocket boots or your flight time will be horrible.",
    availability: "Post-Queen Bee",
    parent: "Force of Life",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: 8 needles spray out from you in a ring while attacking. Enemies hit by your needles will explode into more needles upon death. Each needle does 20 damage and hits one enemy at a time. Finally, it grants immunity to Eternity Mode cactus damage in both inventory and vanity slots. \n\nDespite being obtained very early, the damage is impressively high when close to your enemies due to the number and damage of needles. Don\u2019t expect this to be useful in mid to late pre-hardmode, but it will kill the Eye of Cthulhu with ease. Additionally, although cactus damage is easily blocked by defense, this prevents that minor annoyance.",
    availability: "Pre-Boss",
    parent: "Force of Life",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Every 40 damage you take in a single hit, you spawn one floating bone that can be picked up to heal for 20 health. If you reach 0 HP, you will revive with 50 HP and spawn several bones. \n\nThe revive alone makes this a good accessory, since 50 HP + bones instead of dying means you\u2019ll have a lot of extra survivability. However, creating healing bones when hit is remarkably powerful, assuming you bother to pick them up; if you lose 80 hp from a big hit and then pick up two bones, you just healed half of that entire hit.",
    availability: "Pre-Boss",
    parent: "Force of Spirit",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Allows whips to benefit from melee speed bonuses again in Eternity Mode, whips have +20% range, whips scale with your strongest class instead (but still use melee speed and deal summon damage), and whipping any minion or projectile makes it deal 1.2x damage on its next hit.\n\nDo you use a whip? If so, this is almost mandatory since it makes your whips much more powerful. They will swing faster, buff your minions, hit everything from farther away, and if you want to pull off some kind of galaxy brained build where you use a whip as a mage, this is how you do it. If you don\u2019t ever use whips, this is useless. Tiki is most useful on those whips that whip faster after whipping, such as Dark Harvest, since they can give minions the bonus more often. \n\nThis also makes whips better as an Apprentice Enchantment sidearm. Also, although the idea of using whips as a melee, ranged, or mage character is intriguing, I wouldn\u2019t bother; every time i tried to theorycraft a mage whip build, I went \u201cbut why dont i just go summoner and get just as much whip damage and also a billion minions\u201d.",
    availability: "Post-Plantera",
    parent: "Force of Spirit",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: You have a chance to inflict darkness to enemies, enemies inflicted with darkness will occasionally shoot shadowflame tentacles at other enemies, and grants the effects of Shadow enchantment, but with 3 orbs instead of 2. \n\nGood crowd control, nice against bosses with multiple parts, like skeletron prime, plantera, the twins, and even golem. The damage isn\u2019t spectacular, and damage is all it does, but it\u2019s still very good.",
    availability: "Hardmode",
    parent: "Force of Death",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Gives you a dash that makes you immune to all damage and debuffs for half a second, and deals damage to enemies, but the dash has a cooldown double that of most dashes. Lightning aura sentries gain the ability to crit and they also strike faster. \n\nGood for iframing through an attack such as Retinazer\u2019s deathray or Lifelight\u2019s deathray or anything similar, as well as for iframing through contact damage. It also deals reasonable damage to any enemies you dash through. Lightning aura sentries are difficult to use, but the buff is fairly large, so you might as well place some sentries.",
    availability: "Post-First Mech Boss",
    parent: "Force of Death",
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Gives you a dash that teleports you forward and through walls until there is an opening. Greatly enhances Lightning Aura effectiveness. \n\nUsed for almost identical things as Monk Enchantment, but now you\u2019re using it on Empress of Light\u2019s projectiles and Moon Lord\u2019s lasers and Duke Fishron\u2019s dashes. Note that you have competition in the form of Pumpking\u2019s Cape and Betsy\u2019s Heart now, so you may prefer those instead, but this is still great.",
    availability: "Post-Golem",
    parent: "Force of Death",
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: While attacking, fire your next closest weapon's projectile as support, at 1/7 the typical fire rate. Weapon still consumes mana, bullets, or any other resources it normally would. Buffs Flameburst sentries. \n\nThe damage is lackluster when used purely for DPS, but it\u2019s good for support weapons that inflict things like Ichor or Betsy\u2019s Curse, or for whips if you want to give minions tag damage while doing something else. Of course, if you solely want to inflict one debuff very occasionally, you could always just switch weapons sometimes\u2026",
    availability: "Post-First Mech Boss",
    parent: "Force of Death",
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: While attacking, fire your next closest weapon's projectile as support, at 1/5 the typical fire rate. Weapon still consumes mana, bullets, or any other resources it normally would. Additionally buffs Flameburst sentries and summons a special Flameburst minion above your head. \n\nApprentice but better. The extra minion and higher fire rate pushes this into being a rather good enchantment.",
    availability: "Post-Golem",
    parent: "Force of Death",
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: If you\u2019re moving slowly, your projectile speed is significantly increased, and all your projectiles have extra crit chance based on their speed, up to 20%. Gives you a small damage boost most of the time, and makes it easier to hit with projectiles when moving slowly.",
    availability: "Post-King Slime",
    parent: "Force of Death",
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Grants a powerful dash with unique vertical momentum cancelling, diagonal angling properties, and the ability to jump while dashing into the ground to gain a speed boost. Using this jump dash speed boost grants you the First Strike buff, which triples your next attack\u2019s damage and reduces enemy defense by 10 on hit. \n\nThis is a very powerful though strange dash reminiscent of a Celeste wavedash. It\u2019s possible you\u2019ll have a lot of fun with this enchantment; recommended if you can\u2019t live without a dash and want a good dash in hardmode. It\u2019s hard to rank since it\u2019s very playstyle dependent.\n\nThe First Strike buff is hard to take advantage of with any rapid fire weapons, but it\u2019s decent with slow weapons and excellent with mythril melee weapons, since they gain extra damage while held and not attacking: combine with Striking Moment from Silver Enchantment for some funny hijinks.",
    availability: "Post-Queen Slime",
    parent: "Force of Death",
  },
  {
    name: "Force of Will",
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Gives a 20% chance for enemies (but not bosses) to roll their loot tables 5 times. \n\nBasically gives double loot. More money, more rare drops, more everything. Make this and use it when grinding anything, but since it has a tricky crafting recipe (use portable sundial and underground lumberjack to get the diamond squirrel) you may have trouble making this very early on.",
    availability: "Pre-boss",
    parent: "Force of Will",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Attacks deal an extra 3 flat damage and ignore 6 defense, and each successive attack ignores an additional 6 defense and deals 3 more damage. This stacks up to 10 times, but if you miss an attack, these bonuses get halved. Minions and homing projectiles will not activate or benefit from this effect. \n\nReally good with fast attacking, low damage, accurate projectiles. Don\u2019t miss or you\u2019ll lose your bonus. Damage buildup has a short cooldown, meaning it takes a while to max out your meter, which keeps this out of four stars.",
    availability: "Post-First Mech Boss",
    parent: "Force of Will",
  },
  {
  ...
  },
  {
    ...
    type: "Force",
    description:
      "Effects: Grants the Time Stop active skill, improves your movement speed and acceleration, upgrades all enchantments equipped to their wizard forms, and constantly generates moons while attacking: stop attacking to unleash the moons which deal heavy damage and explode into stat-boosting boosters.\n\nAn extremely powerful force: the moon damage is small but significant, and the time stop active skill, minor mobility boost, and extremely powerful boosters are very nice. Finally, its ability to wizard boost any enchantment (even ones not comprising its components) can be unexpectedly useful.",
    availability: "Post-Eridanus",
    parent: "Soul of Terraria",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "(\u2b50\u2b50\u2b50\u2b50 in DLC) \n\nEffects: Allows you to build up charge while attacking, which grants up to 20% damage reduction: stop attacking to consume all charge and emit a solar shockwave that deals high amounts of melee damage, but has falloff on subsequent hits. \n\nThe damage and damage reduction are both reasonably good, but this is competing with forces. Many forces can give you better offensive and defensive boosts. The most unfortunate fact about this is that it\u2019s a crowd control force in a mod where all the late game bosses are single targets.\n\nIf you\u2019re playing Calamity with the Souls DLC, this is unusually strong against worms or Ceaseless Void\u2019s dark energy minions since it can hit a lot of them in one shockwave, even if it has damage falloff. Wouldn\u2019t recommend on Devourer of Gods though, just because the boss has a lot of HP and the body segments have 95% damage reduction.",
    availability: "Post-Moon Lord",
    parent: "Force of Cosmos",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "(\u2b50\u2b50\u2b50\u2b50 in DLC) \n\nEffects: Once every 3 seconds, replaces one of your projectiles with a homing nebula shot that deals magic damage and spawns a nebula armor nebula booster: buff stacking is capped at 2, and mana boosters are not spawned. \n\nOkay damage from the nebula shots, and good life regen and damage boosts from the buffs. These are identical to the vanilla boosters, so this is useless if you have nebula armor equipped. Great with eridanus armor or gaia armor or even on non-mages, but also it\u2019s competing with forces. Note that in the DLC, nebula boosters are nerfed, but you don\u2019t immediately have forces post-ML so it\u2019s arguably still great.",
    availability: "Post-Moon Lord",
    parent: "Force of Cosmos",
  },
  {
  ...
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by the Dungeon Guardian\nEffects: Grants immunity to Unlucky and Stunned, increases spawn rate, and all non-boss enemies drop double loot. Boss enemies can also drop double loot, but only if you equip the accessory for the entire fight. \n\nA great farming accessory, but the buffed Eternity mode Dungeon Guardian will prevent all but the weirdest lunatics from getting it pre-boss. Most people will get this post-moon lord, after they\u2019ve already stopped grinding most normal enemies for things. Platinum Enchantment is more convenient, but this can be used alongside it.",
    availability: "Pre-Boss",
    parent: "Soul of the Master",
  },
  {
  ...
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by King Slime \nEffects: Grants immunity to Slimed and 2 defense. Gives you extra fall speed, and whenever you land from a jump, slimy balls which inflict Slimed and Oiled rain from the sky at your cursor. An optional toggle allows you to fall through platforms on a very, very short cooldown. \n\nMost useful when you have some source of fire debuffs, but the Oiled is redundant with Ancient Cobalt Enchantent; or just Cobalt Enchantment. Then again, if you don\u2019t have either of those, the Oiled is still good, and the balls do a little extra damage. Fall speed is okay but overrated in my opinion, same with the ability to fall through platforms.",
    availability: "Post-King Slime",
    parent: "Supreme Deathbringer Fairy",
  },
  {
    name: "Agitating Lens",
    rating: "\u2b50\u2b50\u2b50",
    type: "Accessory",
    description:
      "Dropped by Eye of Cthulhu\nGrants immunity to Berserked. While dashing or running quickly, you spawn scythes that go in the direction you\u2019re running. When you use the active skill, you get 20% damage, 20% crit, and a massive attack speed increase for 7.5 seconds, however, you also lose 20 defense, 30% damage reduction, and you can\u2019t stop moving or attacking. After this ability ends, you get stunned for 2.5 seconds. \n\nThe blood scythes deal reasonable damage, but the active skill is controversial and rarely used; it has massive offensive benefits, but could get you killed. I used it to great success on many pre-hardmode bosses, but yes, it did also get me very, very killed sometimes.",
    availability: "Post-Eye of Cthulhu",
    parent: "Supreme Deathbringer Fairy",
  },
  {
  ...
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by a Sand Elemental with a 100% chance in PHM, or with a 20% drop chance in HM Effects: Grants immunity to Mighty Wind. Makes you respawn twice as fast if no boss is alive, and allows you to teleport to your last death point. \n\nJust really nice to have. Makes dying more tolerable while grinding, and reduces time between boss attempts significantly.",
    availability: "Pre-Boss",
    parent: "Bionomic Cluster",
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by any evil critter with a 5% drop chance Effects: Grants immunity to Squeaky Toy and Guilty. Gives you a 10% chance to take 1 damage from an attack. \n\nIf you\u2019re ramming your face against a boss, you just have to get lucky once to beat it. Not that great on average though.",
    availability: "Pre-Boss",
    parent: "Bionomic Cluster",
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by a Jungle Mimic with a 10% drop chance Effects: Grants immunity to Webbed and Purified. Gives you 6 defense. When attacking by manually clicking, your non-summon weapons deal 30% more damage. \n\n30% damage is good, but it\u2019s not as massive as it seems since a lot of your damage is starting to come from accessories, and you have substantial damage bonuses now which makes an additive 30% smaller in comparison. You also have to find a weapon worth manually clicking with to make using this a good idea.",
    availability: "Hardmode",
    parent: "Bionomic Cluster",
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by a Rune Wizard with a 10% drop chance Effects: Grants immunity to Suffocation. Gives you the Mana Flower\u2019s effect, as well as increasing pickup range for mana stars. All effects work from vanity/inventory. \n\nIt\u2019s free mage quality of life, and it makes it easier to trigger Pearlwood\u2019s buff from its own stars, but that's really it. You can also walk around in space now.",
    availability: "Hardmode",
    parent: "Bionomic Cluster",
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by The Flying Dutchman with a 20% drop chance Effects: Gives you immunity to Midas, and reforges have -50% cost.\n\nNow you can spend one billion platinum at the goblin instead of two billion platinum.",
    availability: "Hardmode",
    parent: "Bionomic Cluster",
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by Goblin Warlock with a 10% drop chance \nEffects: Gives immunity to Shadowflame. While attacking, build up shadowflame charge, at the cost of having 10% less damage reduction. Stop attacking to unleash a shadowflame tentacle shotgun blast that deals magic damage. \n\nThe damage isn\u2019t awful, but -10% damage reduction really hurts, and it hurts more the more damage reduction you had in the first place.",
    availability: "Hardmode",
    parent: "Bionomic Cluster",
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by a Nymph with a 10% drop chance \nEffects: Gives you immunity to Lovestruck, Stinky, and Hexed. Your attacks can spawn hearts, and even in inventory or vanity, it makes you respawn with full health. \n\nReally good for Deviantt. Respawning with full health is nice, too. Spawning hearts on hit is also excellent for general survivability on any boss.",
    availability: "Pre-Boss",
    parent: "Bionomic Cluster",
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by Tim with a 10% drop chance \nEffects: Makes some enemies drop potions while equipped. \n\nThis + Platinum Enchantment makes farming potions a breeze. You should definitely get this. Clowns drop Greater Luck potions, by the way.",
    availability: "Pre-Boss",
    parent: "Bionomic Cluster",
  },
  {
  ...
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by The Twins \nEffects: Gives you immunity to Cursed Inferno and Ichor. \nIf you\u2019re inflicted with Cursed Inferno, you gain 15% increased attack speed, and if you\u2019re inflicted with Ichor, you gain 15% increased crit chance. If you\u2019re losing health to a DoT debuff, you inflict Cursed Inferno and Ichor yourself.\nFinally, it grants you an active skill that will inflict you with Cursed Inferno and Ichor (bypassing immunity) until you activate it again. \n\nDecently risky, with a pretty big reward. Synergizes well with Orichalcum, or with rapid fire low damage weapons that benefit from Ichor.",
    availability: "Post-Twins",
    parent: "Dubious Circuitry",
  },
  {
    name: "Remote Control",
    rating: "\u2b50\u2b50\u2b50",
    type: "Accessory",
    description:
      "Dropped by The Destroyer \nEffects: Grants immunity to Lightning Rod. Spawns probes that surround you, providing reasonable summon damage. Getting hit by an electric attack or a ray attack will supercharge you and make you take half damage from the attack that supercharged you. Being supercharged gives you increased attack speed, increased move speed, and the ability to inflict Lightning Rod. \n\nProbes minions are good, and supercharging is good. If you killed Destroyer first, all other mechanical bosses have laser attacks you can supercharge from, and the damage of their basic red lasers (not retinazer\u2019s giant deadly red laser though) is lower than that of their other attacks.",
    availability: "Post-Destroyer",
    parent: "Dubious Circuitry",
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by Skeletron Prime\nEffects: Grants immunity to Nano Injection, knockback, and Defenseless, as well as 15 defense and 5% damage reduction. \n\n15 defense is a lot of defense, knockback immunity is nice, and 5% damage reduction is good. Can be combined with its Dubious Circuitry upgrade for a total of 25 defense and 10% damage reduction.",
    availability: "Post-Skeletron Prime",
    parent: "Dubious Circuitry",
  },
  {
    name: "Pure Heart",
  ...
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by the Eater of Worlds \nEffects: Grants immunity to Rotting. Increases your turnaround traction, and increases movement speed by 10%. You occasionally emit homing mini eaters that inflict Cursed Inferno on enemies. \n\nOkay mobility and very nice damage. Not much to say. The movement boosts are smaller than Meteor Enchantment, but you do gain a small top speed increase while flying, so you may prefer this if you remain airborne a lot.",
    availability: "Post-Eater of Worlds",
    parent: "Pure Heart",
  },
  {
    name: "Gutted Heart",
    ...
    type: "Accessory",
    description:
      "Dropped by the Brain of Cthulhu \nEffects: Grants immunity to Bloodthirsty. Increases your max life by 10%, and spawns up to 5 creepers (one every 15 seconds while moving, faster while not moving) that block damage. \n\nThe creepers are extremely good and block projectiles completely much of the time, but watch out for forms of damage that pierce through and shred your creepers such as giant deathrays or boss contact damage. 10% max life is also a useful boost.",
    availability: "Post-Brain of Cthulhu",
    parent: "Pure Heart",
  },
  {
    name: "Gelic Wings",
  ...
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by the Wall of Flesh\nEffects: Gives immunity to Blackout and Obstructed. Enemies near your cursor take increased damage, scaling with how long you track them with your cursor. Increases the spawn rate of rare enemies detectable by lifeform analyzer by 5x. \n\nThe increased damage to enemies in your cursor is less useful than it seems since it builds up slowly and moving your mouse away from the enemy for even a moment makes you lose all the built up vulnerability, but you shouldn\u2019t equip it for that alone anyway: the drastically increased spawn rate of rare enemies is amazing for farming the Bionomic Cluster, and where the three star rating comes from.",
    availability: "Hardmode",
    parent: "Lump of Flesh",
  },
  {
    name: "Crystal Skull",
    rating: "\u2b50\u2b50\u2b50\u2b50\u2b50",
  ...
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by the Dreadnautilus with a 20% drop chance \nEffects: Grants immunity to Anticoagulation and knockback. Increases defense by 2, and grants a parry with extremely tight timing. Upon parrying, blood spikes that inflict Anticoagulation to enemies and release blood boosters that increase damage when collected. Defense and damage reduction is reduced for a few seconds whenever a parry attempt is made or when the shield is held up during the parry cooldown. \n\nExcellent for blocking damage and inflicting massive damage, but its timing is extremely tight, and the defense penalties are harsh. Silver Enchantment shortens the cooldown and increases the parry window. Extremely good at countering Retinazer\u2019s giant spinning deathray, and can kill Queen Slime\u2019s subjects instantly. \n\nTIP FOR PARRYING: You can\u2019t parry during your weapon\u2019s use time cooldown, so wait for your weapon to vanish before right clicking.",
    availability: "Hardmode",
    parent: "Lump of Flesh",
  },
  {
  ...
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by Plantera\nEffects: Grants immunity to Acid Venom, Ivy Venom, and Swarming. Increases your life regen depending on how lit up the area around you is (min +1 HP/s, max +4 HP/s), and gives you a plantera minion which shoots seeds and spiky balls. Allows you to press the Magical Cleanse key to cure yourself of most debuffs, as well as doubling debuff damage for 45 seconds, with a 40 second cooldown. \n\nMagical Cleanse is amazing for erasing debuffs, and it\u2019s most useful on Golem who has devastating defense-wrecking debuffs, as well as on any builds that inflict powerful debuffs since for some reason Magical Cleanse gives you almost permanent double debuff damage. Finally, the plantera minion is uniquely good on slow moving bosses like Golem, but bad on other bosses.",
    availability: "Post-Plantera",
    parent: "Verdant Doomsayer Mask",
  },
  {
  ...
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by Lunatic Cultist Effects: Grants immunity to Marked for Death. Causes you to fire additional projectiles depending on your weapon type. \n\nUsable on pillars, and then crafted into the Doomsayer Mask. It deals decent bonus damage, but that\u2019s it.",
    availability: "Post-Lunatic Cultist",
    parent: "Verdant Doomsayer Mask",
  },
  {
  ...
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by the Ice Queen with a 20% drop chance \nEffects: Grants immunity to Hypothermia. Gives you 5% DR, and allows you to graze attacks to gain an ice bomb that when used can freeze (as if time stopped) almost all enemies and projectiles within 150 tiles for 1 second, then chills them for 3 seconds, slowing them. \n\nHas anyone ever used the bomb? I think I remember using it exactly once, being unimpressed, and equipping something else. If you want a timing-based way of avoiding damage, just use Pumpking\u2019s Cape. Or Betsy\u2019s Heart. Or any iframe dash. Or any kind of teleport. Might be okay if all those things didn't exist.",
    availability: "Post-Ice Queen",
    parent: "Heart of the Master",
  },
  {
  ...
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by Duke Fishron \nEffects: Grants immunity to Wet, Feral Bite, Mutant Nibble, Oceanic Maul, and debuffs caused by entering water. Increases all damage by 20% and permanently grants the effects of Wet while riding Cute Fishron. Reduces life regen by 1 hp/second. \n\nFree all-class damage boost, and perfect for the valhalla enchantment cute fishron build. The life regen penalty is barely a thing.",
    availability: "Post-Duke Fishron",
    parent: "Heart of the Master",
  },
  {
    name: "Precision Seal",
    ...
    type: "Accessory",
    description:
      "Dropped by the Empress of Light \nEffects: Grants immunity to Smite. Shrinks your hitbox significantly and gives access to \u201cPrecision Mode,\u201d which shows your hitbox and disables dashes and double jumps so you don\u2019t accidentally use them. Precision seal hitbox pictured below. \n\nA great accessory, but I think it\u2019s non-upgraded form is overrated; a smaller hitbox may sometimes let you dodge projectiles you otherwise wouldn\u2019t have, but the fights you genuinely get the most benefits from are all post-moon lord, where you have it built into Heart of the Master.",
    availability: "Post-Empress of Light",
    parent: "Heart of the Master",
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by Moon Lord \nEffects: Grants immunity to Flipped, Unstable, Nullification Curse, and Curse of the Moon, as well as 10 defense. Lets you control gravity, summons True Eyes of Cthulhu to protect you, and increases wing flight time by 100%. Grants nearly all potion buffs. \n\nBasically just gets crafted into Heart of the Master immediately, but the true eye minions and extra flight time can be useful in the 5 milliseconds between killing Moon Lord and upgrading the item.\n\nBecause it increases flight time by 100% instead of 50% like its upgrade, in theory you could use this alongside Force of Life instead of just using Heart of the Master for more flight time. I don\u2019t know why you would sacrifice all the other benefits of Heart of the Master for more flight time though\u2026",
    availability: "Post-Moon Lord",
    parent: "Heart of the Master",
  },
  {
    ...
    type: "Soul",
    description:
      "(\u2b50\u2b50\u2b50\u2b50\u2b50 in DLC) \n\nEffects: Grants 10 defense, +10% damage reduction, 100 max life, and +5 life regeneration. Grants lots of immunities, including to knockback, and has the effects of many vanilla defensive accessories. \n\nThis does one thing: defense. It\u2019s a great accessory. Has the effects of Charm of Myths, providing a slight synergy with anything that boosts healing potions or mushrooms (Force of Nature and Force of Spirit, and to a lesser extent Force of Will). Note that it\u2019s stronger with the Souls DLC installed since most of Calamity\u2019s own defensive accessories are crammed into this as well.",
    availability: "Post-Moon Lord",
    parent: "Soul of Dimensions",
  },
  {
  ...
  },
  {
    ...
    type: "Soul",
    description:
      "(\u2b50\u2b50\u2b50\u2b50 in DLC) \n\nEffects: Grants high speed infinite flight: you can hover by holding down and jump simultaneously, and hold up to boost faster. Finally, it increases gravity, allowing you to fall faster, and disables all your jumps (togglable) \n\nThis is a very good accessory, but Force of Life in my opinion outclasses it despite having worse flight statistics due to the giant pile of other benefits it offers. You may still prefer the faster flight this accessory offers, as well as the lack of dependence on flowers.\n\nIn the DLC though, Force of Life has better flight time statistics due to assorted calamity wing movement buffs, and the difference between the two wings is much smaller, so just use Life instead.",
    availability: "Post-Moon Lord",
    parent: "Soul of Dimensions",
  },
  {
    ...
    type: "Soul",
    description:
      "Effects: Grants godlike fishing buffs, and has effects of some fishing related accessories, including Spore Sac. \n\nAngler enchantment allows you to fish up every single object you could conceivably want, and this is only obtainable post-moon lord, and it requires rare fishing drops like Bladetongue in the first place. What fishing am I supposed to do with this? I already caught every fish in the game!",
    availability: "Post-Moon Lord",
    parent: "Soul of Dimensions",
  },
  {
    ...
    type: "Soul",
    description:
      "(\u2b50\u2b50\u2b50in DLC) \n\nEffects: Grants godlike mining and building powers, and also allows you to enable Builder Mode, which provides a variety of benefits, most notably the ability to place any placeable tile or block without consuming it. \n\nFantastic at construction, but surely you didn\u2019t wait until the game was almost over to build a nice house for yourself, right? Have you been living in an Insta-House this whole time?\n\nBuilder Mode lets you duplicate all kinds of things, from metal ingots to platinum coins, but there\u2019s little need for this, except in the DLC, where you may want to produce a ton of Shadowspec or Auric bars very quickly. \n\nIt\u2019s even capable of duplicating the Rock, obtained from the boss rush or from Wrath of the Gods content, allowing you to craft more endgame items.",
    availability: "Post-Moon Lord",
    parent: "Soul of Dimensions",
  },
  {
  ...
  },
  {
    ...
    type: "Soul",
    description:
      "(\u2b50\u2b50\u2b50\u2b50\u2b50 in DLC) \n\nEffects: Grants 22% ranger damage, 20% increased ranged weapon velocity, and 10% ranged crit chance; additionally has the effects of the sniper scope and magic quiver. \n\nWorse than its melee/mage siblings but not by much. Crit chance is also only useful if you equipped none of the forces that take you to 100% crit chance anyway. Increased velocity is nice, but only if you\u2019re using a weapon that benefits from it (so not the scientific railgun).\n\nThe Magic Quiver part is only useful on Nano Core\u2019s ranged mode in non-DLC eternity mode, since that is, for some reason, the only post-moon lord bow. But since it\u2019s only a 10% boost and it\u2019s no longer multiplicative as of terraria 1.4.4, equip other accessories instead. All souls have Calamity items built in with the DLC, including both their obvious tooltip effects and the stat bonuses from the original Calamity items, making them auto-equips.",
    availability: "Post-Moon Lord",
    parent: "Soul of the Universe",
  },
  {
    ...
    type: "Soul",
    description:
      "(\u2b50\u2b50\u2b50\u2b50\u2b50 in DLC) \n\nEffects: Grants 22% magic damage, 20% reduced mana cost, and 10% magic crit chance; additionally grants 200 max mana and the effects of the celestial cuffs and mana flower. \n\nA large suite of very good mage damage boosts, but that's all it does. Magic attack speed is more useful than melee speed since more weapons use it. The crit chance is also only useful if you equipped none of the forces that take you to 100% crit chance anyway.\n\nAll souls have Calamity items built in with the DLC, including both their obvious tooltip effects and the stat bonuses from the original Calamity items, making them auto-equips.",
    availability: "Post-Moon Lord",
    parent: "Soul of the Universe",
  },
  {
    ...
    type: "Soul",
    description:
      "(\u2b50\u2b50\u2b50\u2b50\u2b50 in DLC) \n\nEffects: Grants 22% summoner damage, 15% whip range, 3 minion slots, and 1 sentry slot. \n\nThree summoner slots plus some other stuff! Very good if you're a summoner. It\u2019s even great on Mutant as a bonus accessory since the slots add on top of Soul of the Universe\u2019s +2 slots. \n\nAll souls have Calamity items built in with the DLC, including both their obvious tooltip effects and the stat bonuses from the original Calamity items, making them auto-equips. By the way, this one has Nucleogenesis built in, meaning it actually grants seven slots in the DLC.",
    availability: "Post-Moon Lord",
    parent: "Soul of the Universe",
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Increases mining speed by 50%. Effects of Spelunker, Night Owl, Shine, Hunter, and Dangersense potions. \n\nUnnecessary if you already have these potions and don\u2019t want the mining speed, but it does at least make you throw boom shurikens faster.",
    availability: "Pre-Boss",
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Increases fishing skill, fish bite your bobber almost immediately, and grants the effects of Lava Proof Tackle Bag. \n\nSurprisingly easy to craft, and powerful; the nearly instant fishing lets you grab truly enormous piles of fishing loot.",
    availability: "Pre-Boss",
    parent: "Miscellaneous",
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped By Trojan Squirrel\nEffects: While in inventory, standing still gives you a weaker Spelunker Potion effect that only adds fancy sparkles near valuables, as well as the Hunter Potion effect. Enemies emit light at night, and grants autofire to non-weapon items. \n\nYou killed Trojan Squirrel, so you might as well keep it in your inventory for the mild bonuses. It doesn\u2019t actually do anything unique if you put it in an accessory slot though. Wait, is this even an accessory? I never tried putting this in a slot so I have no idea. Whatever, I\u2019m lumping it in with all the other \u201cin inventory/vanity\u201d accessories anyway.",
    availability: "Post-Trojan Squirrel",
    parent: "Miscellaneous",
  },
  {
  ...
  },
  {
    ...
    type: "Accessory",
    description:
      "Effects: Combines Terraspark Boots and Fart in a Bottle, granting you both the double jump and the speed. Speed is increased further from Lightning Boots. \n\nThe best boots available in pre-hardmode: the double jump can eliminate the need for wings in some situations in early hardmode as well.",
    availability: "Post-Deviantt",
    parent: "Miscellaneous",
  },
  {
    ...
    type: "Soul",
    description:
      "(Die to a wolf to get this accessory)\nPatreon item Effects: Double tap the left or right movement keys to perform an invincible wolf dash that travels 30 blocks. The dash deals 50 Melee damage but does not inflict melee/whip specific debuffs (flasks, fire gauntlet) It\u2019s an iframe dash. \n\nGood in the same ways Monk Enchantment is, but has much less damage. Haven\u2019t ever used this myself since I always forget about it.",
    availability: "Hardmode",
    parent: "Miscellaneous",
  },
  {
    ...
    type: "Accessory",
    description:
      "Effects: Same effects as Zephyr Boots. Increases jump height and fall damage resistance, flowers spawn beneath your feet, and you run faster on sand. \n\nEven better boots; get these if you ever want to go fast without using a mount. Not always necessary; Plantera and Golem can be easily fought using only wings and no boots, but if you want to fight Duke Fishron without a mount, these are very useful.",
    availability: "Post-Mech Bosses",
    parent: "Miscellaneous",
  },
  {
    ...
    type: "Accessory",
    description:
      "Dropped by Golem with a 10% drop chance \nPatreon item \nEffects: Non-Magic / Summon attacks deal 1.2x damage but are affected by mana sickness and cost half of the weapon\u2019s use time in mana to use. \n\nNever results in a spectacular boost, but can be handy as an extra damage multiplier. Can even be used on Mutant, since multiplicative damage is very useful at that point and you may be looking to fill an extra accessory slot.",
    availability: "Post-Golem",
    parent: "Miscellaneous",
  },
  {
    ...
    type: "Accessory",
    description:
      "(\u2b50\u2b50\u2b50 specifically when fighting mutant as summoner) \nDropped by Eridanus\nEffects: Critical hits can critically hit with half the crit chance of a regular crit (capped at 33% supercrit chance), dealing 4x damage instead of only 2x, along with inflicting Flames of the Universe. \n\nYour critical hit chance is almost certainly 100% by now, so this is effectively 1.33x damage on any post-Eridanus boss. Note that Mutant disables spider crits, meaning summoners get less use from this when fighting him in particular, but it still works on all the non-summon damage from things like the styx armor set bonus. Otherwise, it is virtually mandatory in all loadouts after killing Eridanus.",
    availability: "Post-Eridanus",
    parent: "Miscellaneous",
  },
  {
  ...
  },
  {
    ...
    type: "Accessory",
    description:
      "Effects: 18% increased magic damage, 8% increased magic crit, and increases your maximum mana by 50. \n\nIt\u2019s fiiiiiine, but you can do better than this: all it offers are moderate offensive boosts. Very low as far as three star accessories go.",
    availability: "Post-First Mech Boss",
    parent: "Miscellaneous",
  },
  {
    ...
    type: "Accessory",
    description:
      "Effects: 18% increased melee damage, 10% increased melee speed, and 8% increased melee crit chance. \n\nSame deal as Apprentice\u2019s Essence, but a little better. It\u2019s fiiiine. Whatever. It\u2019s probably slightly better than Apprentice\u2019s, but not by a whole lot. Not very good when used on weapons that don\u2019t care about attack speed, such as yoyos (technically their string lengthens but not that big of a deal).",
    availability: "Post-First Mech Boss",
    parent: "Miscellaneous",
  },
  {
    ...
    type: "Accessory",
    description:
      "Effects: 18% increased summon damage, 10% increased whip range, and increases your max number of minions by 1. \n\nThe strongest essence due to the minion slot. Just enough to boost it to four stars.",
    availability: "Post-First Mech Boss",
    parent: "Miscellaneous",
  },
  {
    ...
    type: "Accessory",
    description:
      "Effects: 18% increased ranged damage, 10% increased velocity on ranged weapons, and 8% increased ranged critical chance. \n\nTied with the Apprentice\u2019s Essence for weakest essence. Increased weapon velocity is nice I guess.",
    availability: "Post-First Mech Boss",
    parent: "Miscellaneous",
  },
  {
    ...
    type: "Accessory",
    description:
      "Effects: Grants running speed, but not as fast as hermes boots. \n\nYou start out with these, so you might as well put them on. Surprisingly viable against Trojan Squirrel, but you\u2019ll want to replace them when possible.",
    availability: "Pre-Boss",
    parent: "Miscellaneous",
  },
  {
    ...
    type: "Accessory",
    description:
      "Effects: Grants a very weak double jump. \n\nYou also start out with this. It\u2019s better than nothing, and surprisingly viable on Trojan Squirrel, but replace it when you can. At least you can equip this one alongside other double jumps and use this to stop fall damage, so it\u2019s better than the Eurus socks in that regard.",
    availability: "Pre-Boss",
    parent: "Miscellaneous",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Gain the ability to charge up your ground jumps for extra height; additionally, you can dive towards the ground to fall faster. Doing either of these things damages and knocks back nearby enemies. \n\nExtremely fun enchantment, though like with Snow Ruffian, its mostly for goofing off and general exploration. Outperformed by Ancient Cobalt in practice, but it\u2019s easier to get. It also helps you get initial height for your Snow Ruffian gliding. I don\u2019t think people use this for boss fights, but it could be fun to try it out.",
    dlc: true,
    availability: "Pre-Boss",
    parent: "Force of the Gale",
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Spikes extend from your body, which grant 4 defense while attached; attack to charge the spikes, and release to shoot the spikes. \n\nReasonably okay accessory-based damage to early pre-hardmode bosses. 4 defense isn\u2019t a lot, but I\u2019ll take it.",
    dlc: true,
    availability: "Post-Desert Scourge",
    parent: "Force of the Gale",
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Grants a sulphur double jump that releases a sulphur bubble on use: when you attack the bubble, it emits gas that damages nearby enemies. \n\nReasonably okay accessory-based damage to some pre-hardmode bosses, and this one also has a double jump. Requires you to bother to attack the bubble to get any damage from it.",
    dlc: true,
    availability: "Post-Eye of Cthulhu",
    parent: "Force of the Gale",
  },
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Increases flight time by 25%. After a second in the air without landing or getting hit, your attacks occasionally spawn several special energy arrows from the sky on the cursor. Getting hit also halves your remaining wing time. \n\nBig damage. Very big damage! Some bosses are easier to hit with the arrows than others, but a regular daedalus will do a lot of damage, and a wizard-boosted daedalus will do even more damage due to extra arrow damage, amount, and velocity. Extra flight time is nice and helps mitigate the one downside of the enchantment. Just make sure to fly around a lot and avoid landing on platforms, or else you won\u2019t get your cool arrows.",
    dlc: true,
    availability: "Post-Cryogen",
    parent: "Force of the Elements",
  },
  {
  ...
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: A drone follows your cursor and scans enemies, telling you their debuff weaknesses/resistances in Calamity\u2019s special elemental debuff type system. Scanned enemies take flat extra damage over time while under the effects of any damaging debuff. \n\nCheap to make with a mild benefit, and unique in that it funnels you down looking up how debuffs work in Calamity, making you go insane as you try to put a debuff build together. Good item, but unequip it when you find something better. Useless if you never inflict a debuff.",
    dlc: true,
    availability: "Pre-Boss",
    parent: "Miscellaneous",
  },
  {
    ...
    type: "Enchantment",
    description:
      "Effects: Grants +10% tile placement speed and +5 tile placement range. Lasers strike nearby enemies when building and mining, grants effects of the Marnite Repulsion Shield, and grants 2 defense. \n\nBad for straightforward combat, but keeps bats from hitting you while you\u2019re mining and protects you while you build your house. Some combat-oriented tools don\u2019t cause you to shoot lasers. There are niche weaponless builds (or tool-based builds) that use this, but that\u2019s really just a meme strategy, so it\u2019s really just good for building and mining.",
    dlc: true,
    availability: "Pre-Boss",
    parent: "Miscellaneous",
  },
  ...
  },
  {
    ...
    type: "Accessory",
    description:
      "Effects: Grants +18% rogue damage, +5% rogue projectile velocity, and +5% rogue critical hit chance. \n\nIt\u2019s okay. Like usual for essences, it\u2019s mostly just a moderate damage boost and nothing else.",
    dlc: true,
    availability: "Post-First Mech Boss",
    parent: "Miscellaneous",
  },
  {
    ...
    type: "Soul",
    description:
      "Effects: Grants +30% rogue damage, +15% rogue projectile velocity, and +15% rogue critical hit chance. Additionally, grants the effects of Nanotech and the Eclipse Mirror. \n\nEclipse Mirror is basically mandatory for rogues due to all of the massive bonuses its grants, and this gives you even more bonuses on top of that.",
    dlc: true,
    availability: "Post-Yharon",
    parent: "Soul of the Universe",
  },
  {
    ...
    type: "Accessory",
    description:
      "Effects: Grants +50 defense, and the benefits of countless endgame Calamity accessories. Effects such as Draedon\u2019s Heart nanomachines can be toggled in the accessory toggle menu.\n\nThe most powerful accessory the DLC adds, and an essential part of any DLC Mutant loadout. Equip this and then don\u2019t unequip it until you craft the Soul of Eternity.",
    dlc: true,
    availability: "Post-Supreme Calamitas",
    parent: "Miscellaneous",
  },
  {
  ...
  {
    name: "Soul of Terraria",
    rating: "\u2b50\u2b50\u2b50\u2b50\u2b50",
    type: "Soul",
    description:
      "Effects: Effects of every force simultaneously, with small changes such as no inherent wings from force of life, but they don’t really matter. \n\nI don’t think I need to explain why this is five stars. Only ever used on Mutant though, or I guess to make an Abominationn refight much faster.",
    availability: "Post-Abominationn",
    parent: "Soul of Eternity",
  },
  {
  ...
  },
  {
    ...
    type: "Soul",
    description:
      "Effects: Grants a variety of massive damage buffs to all classes, mostly to your currently held weapon class, and has the effect of many vanilla items. Most importantly, grants 4 defense.\n\nI don\u2019t think I need to explain why this is five stars. Only ever used on Mutant though, or i guess to make an Abominationn refight much faster.\n\nNotably, the number of granted minion slots is lower than its Conjurist\u2019s Soul downgrade, so you can equip that if you want more minion slots.",
    availability: "Post-Abominationn",
    parent: "Soul of Eternity",
  },
  {
    ...
    type: "Soul",
    description:
      "Effects: Effects of countless defensive and utility accessories. Grants godly fishing powers and the ability to enable Builder Mode. You fly at high speed with amazing acceleration and can stop nearly instantly, in addition to the ability to hover. Grants lots of maximum HP, defense, and so on.\n\nI don\u2019t think I need to explain why this is five stars. Only ever used on Mutant though, or i guess to make an Abominationn refight much faster. Even though this is the least necessary of the four nearly mandatory mutant killing accessories, this still outclasses any other alternatives to those four accessories.",
    availability: "Post-Abominationn",
    parent: "Soul of Eternity",
  },
];
